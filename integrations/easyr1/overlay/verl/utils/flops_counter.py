...
def _ensure_qwen3_vl_time_codec_from_config() -> None:
    try:
    ...
    if hasattr(Qwen3VLForConditionalGenerationWithTimeCodec, "from_config"):
        return
    ...
    setattr(Qwen3VLForConditionalGenerationWithTimeCodec, "from_config", _from_config)


_ensure_qwen3_vl_time_codec_from_config()


def _ensure_qwen3_vl_cis_codec_from_config() -> None:
    try:
    ...
    if hasattr(Qwen3VLForConditionalGenerationWithCISCodec, "from_config"):
        return
    ...
    setattr(Qwen3VLForConditionalGenerationWithCISCodec, "from_config", _from_config)


_ensure_qwen3_vl_cis_codec_from_config()


def _ensure_qwen3_vl_timeple_codec_from_config() -> None:
    try:
    ...
    if hasattr(Qwen3VLForConditionalGenerationWithTimePLECodec, "from_config"):
        return
    ...
    setattr(Qwen3VLForConditionalGenerationWithTimePLECodec, "from_config", _from_config)


_ensure_qwen3_vl_timeple_codec_from_config()


def _ensure_qwen3_vl_timeple_from_config() -> None:
    try:
        from transformers.models.qwen3_vl.modeling_qwen3_vl_timeple import (
            Qwen3VLForConditionalGenerationWithTimePLECodec,
        )
...
_ensure_qwen3_vl_timeple_from_config()


def _ensure_qwen3_vl_timeed_from_config() -> None:
    try:
        from transformers.models.qwen3_vl.modeling_qwen3_vl_timeed import (
            Qwen3VLForConditionalGenerationWithTimeED,
        )
    except Exception:
        return

    if hasattr(Qwen3VLForConditionalGenerationWithTimeED, "from_config"):
        return
    ...
    setattr(Qwen3VLForConditionalGenerationWithTimeED, "from_config", _from_config)


_ensure_qwen3_vl_timeed_from_config()
...
class FlopsCounter:
    ...
    def __init__(self, config: "LlamaConfig"):
        _ESTIMATE_FUNC = {
            ...
            # Time codec reuses the Qwen3-VL backbone; the extra time modules are negligible for MFU tracking.
            "qwen3_vl_time_codec": self._estimate_llama_flops,
            "qwen3_vl_cis_codec": self._estimate_llama_flops,
            "qwen3_vl_timeple_codec": self._estimate_llama_flops,
            "qwen3_vl_timeple": self._estimate_llama_flops,
            "qwen3_vl_timeed": self._estimate_llama_flops,
